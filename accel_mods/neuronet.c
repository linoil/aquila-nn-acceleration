...
volatile float *nn_weights = (float*)0x00001000;

volatile float *input_a = (float*)0xC4000000;
volatile float *input_b = (float*)0xC4000004;
volatile float *input_c = (float*)0xC4000008;
volatile float *output = (float*)0xC400000C;
...
void neuronet_init(NeuroNet *nn, int n_layers, int *n_neurons)
{
    ...
    for (layer_idx = 1; layer_idx < nn->total_layers; layer_idx++)
    {
        ...
        {
            nn->forward_weights[neuron_idx] = (nn_weights+sum);
